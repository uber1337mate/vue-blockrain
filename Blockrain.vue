<template>
  <div class="blockrain-container">
    <div class="blockrain-game" v-bind:style="{width, height}"></div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    components: {},
    mounted() {
      $('.blockrain-game', this.$el).blockrain(this.config);
    },
  }

  function loadJqueryExtension(jQuery) {
    const tmp = global.jQuery;
    global.jQuery = jQuery;
    const blockrain = require('blockrain');
